...
<html>
<head>
  <title>Research & Development Task task</title>
  <style>
...
<div class="todoList">
  <center><h2 style="color: black;">Research & Development Task</h2></center>
  <div class="content">
    <form class="add">
    ...
    <ul class="todos">
      <li>
        ...
        <label for="todo_1">
          ...
          <b>Sefat:</b>research on business analysis
        </label>
      ...
      <li>
        ...
        <label for="todo_2">
          <span class="check"></span>
          <b>X:</b>research on google data studio
        </label>
