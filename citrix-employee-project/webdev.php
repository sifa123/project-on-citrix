...
<html>
<head>
  <title>web Development task</title>
  <style>
...
<div class="todoList">
  <center><h2 style="color: black;">Web Development Task</h2></center>
  <div class="content">
    <form class="add">
    ...
    <ul class="todos">
      ...
      <li>
        ...
        <label for="todo_3">
          <span class="check"></span>
          <b>Y:</b>Make a workflow of your project
        </label>
